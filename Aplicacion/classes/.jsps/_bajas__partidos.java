  /*@lineinfo:filename=/bajas_partidos.jsp*/
...
public class _bajas__partidos extends com.orionserver.http.OrionHttpJspPage {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:24^13*/      {
        ...
        __jsp_taghandler_1.setAction("/bajasPartidos");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:37^17*/            {
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                ...
                do {
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:40^23*/                  {
                    ...
                    if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
                    {
                      ...
                      /*@lineinfo:translated-code*//*@lineinfo:41^73*/                      } while (__jsp_taghandler_3.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:45^23*/                  {
                    ...
                    __jsp_taghandler_5.setProperty("idlocaciones");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:48^23*/                  {
                    ...
                    __jsp_taghandler_6.setProperty("idparticipantes1");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:51^23*/                  {
                    ...
                    __jsp_taghandler_7.setProperty("idparticipantes2");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:54^23*/                  {
                    ...
                    __jsp_taghandler_8.setProperty("idarbitros");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:57^23*/                  {
                    ...
                    __jsp_taghandler_9.setProperty("idmodalidades");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:60^23*/                  {
                    ...
                    __jsp_taghandler_10.setProperty("idgrandslam");
                ...
                /*@lineinfo:translated-code*//*@lineinfo:60^73*/                } while (__jsp_taghandler_2.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
                __ojsp_s_out = (com.evermind.server.http.JspCommonExtraWriter) out;
              }
          ...
          /*@lineinfo:translated-code*//*@lineinfo:63^33*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
