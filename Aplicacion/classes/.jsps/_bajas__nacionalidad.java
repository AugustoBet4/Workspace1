  /*@lineinfo:filename=/bajas_nacionalidad.jsp*/
...
public class _bajas__nacionalidad extends oracle.jsp.runtime.HttpJsp {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    _bajas__nacionalidad page = this;
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:24^13*/      {
        ...
        __jsp_taghandler_1.setAction("/bajasNacionalidad");
          ...
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:32^17*/            {
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                    ...
                    if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
                    {
                      ...
                      do {
                        ...
                        /*@lineinfo:translated-code*//*@lineinfo:36^25*/                        {
                          ...
                          __jsp_taghandler_4.setProperty("idnacionalidad");
                ...
                /*@lineinfo:translated-code*//*@lineinfo:40^74*/                } while (__jsp_taghandler_2.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
              }
