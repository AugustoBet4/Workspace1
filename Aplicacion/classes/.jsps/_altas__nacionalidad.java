  /*@lineinfo:filename=/altas_nacionalidad.jsp*/
...
public class _altas__nacionalidad extends oracle.jsp.runtime.HttpJsp {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    _altas__nacionalidad page = this;
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:24^13*/      {
        ...
        __jsp_taghandler_1.setAction("/altasNacionalidad");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          ...
          /*@lineinfo:translated-code*//*@lineinfo:43^79*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
