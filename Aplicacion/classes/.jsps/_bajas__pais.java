  /*@lineinfo:filename=/bajas_pais.jsp*/
...
public class _bajas__pais extends com.orionserver.http.OrionHttpJspPage {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:27^13*/      {
        ...
        __jsp_taghandler_1.setAction("/bajasPais");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:35^17*/            {
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                    ...
                    if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
                    {
                      ...
                      do {
                        ...
                        /*@lineinfo:translated-code*//*@lineinfo:39^25*/                        {
                          ...
                          __jsp_taghandler_4.setProperty("idpais");
                      ...
                      /*@lineinfo:translated-code*//*@lineinfo:39^70*/                      } while (__jsp_taghandler_3.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                ...
                /*@lineinfo:translated-code*//*@lineinfo:43^66*/                } while (__jsp_taghandler_2.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
                __ojsp_s_out = (com.evermind.server.http.JspCommonExtraWriter) out;
              }
          ...
          /*@lineinfo:translated-code*//*@lineinfo:46^33*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
