  /*@lineinfo:filename=/bajas_ParticipantesEntrenadores.jsp*/
...
public class _bajas__ParticipantesEntrenadores extends oracle.jsp.runtime.HttpJsp {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    _bajas__ParticipantesEntrenadores page = this;
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:24^13*/      {
        ...
        __jsp_taghandler_1.setAction("/bajasParticipantesEntrenadores");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                ...
                do {
                    ...
                    if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
                    {
                      ...
                      do {
                        ...
                        /*@lineinfo:translated-code*//*@lineinfo:36^25*/                        {
                          ...
                          __jsp_taghandler_4.setProperty("idparticipantes");
                      ...
                      /*@lineinfo:translated-code*//*@lineinfo:36^79*/                      } while (__jsp_taghandler_3.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:40^23*/                  {
                    ...
                    __jsp_taghandler_5.setProperty("identrenadores");
                ...
                /*@lineinfo:translated-code*//*@lineinfo:40^76*/                } while (__jsp_taghandler_2.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
              }
          ...
          /*@lineinfo:translated-code*//*@lineinfo:43^33*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
