  /*@lineinfo:filename=/bajas_premios.jsp*/
...
public class _bajas__premios extends com.orionserver.http.OrionHttpJspPage {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:27^13*/      {
        ...
        __jsp_taghandler_1.setAction("/bajasPremios");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:38^17*/            {
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                ...
                do {
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:41^23*/                  {
                    ...
                    if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
                    {
                      ...
                      do {
                        ...
                        /*@lineinfo:translated-code*//*@lineinfo:42^25*/                        {
                          ...
                          __jsp_taghandler_4.setProperty("idpremios");
                      ...
                      /*@lineinfo:translated-code*//*@lineinfo:42^73*/                      } while (__jsp_taghandler_3.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:46^23*/                  {
                    ...
                    __jsp_taghandler_5.setProperty("cantidad");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:49^23*/                  {
                    ...
                    __jsp_taghandler_6.setProperty("categoria");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:52^23*/                  {
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:55^23*/                  {
                    ...
                    __jsp_taghandler_8.setProperty("idpartido");
                ...
                /*@lineinfo:translated-code*//*@lineinfo:55^71*/                } while (__jsp_taghandler_2.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
                __ojsp_s_out = (com.evermind.server.http.JspCommonExtraWriter) out;
              }
          ...
          /*@lineinfo:translated-code*//*@lineinfo:58^33*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
