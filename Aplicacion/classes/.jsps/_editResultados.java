  /*@lineinfo:filename=/editResultados.jsp*/
...
public class _editResultados extends oracle.jsp.runtime.HttpJsp {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:19^9*/      {
        ...
        __jsp_taghandler_1.setAction("/editResultados");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:24^19*/            {
              ...
              __jsp_taghandler_2.setValue( OracleJspRuntime.toStr( session.getAttribute("idresultados")));
            ...
            /*@lineinfo:translated-code*//*@lineinfo:33^19*/            {
              ...
              __jsp_taghandler_3.setProperty("resultado");
              __jsp_taghandler_3.setStyleClass("form-control-sm");
              __jsp_taghandler_3.setValue( OracleJspRuntime.toStr( session.getAttribute("resultado")));
            ...
            /*@lineinfo:translated-code*//*@lineinfo:42^19*/            {
              ...
              __jsp_taghandler_4.setValue( OracleJspRuntime.toStr( session.getAttribute("idpartido")));
            ...
            /*@lineinfo:translated-code*//*@lineinfo:47^15*/            {
              ...
              __jsp_taghandler_5.setStyleClass("btn btn-success");
              __jsp_taghandler_5.setValue("Actualizar");
          ...
          /*@lineinfo:translated-code*//*@lineinfo:47^78*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
