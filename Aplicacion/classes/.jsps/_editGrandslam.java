...
public class _editGrandslam extends oracle.jsp.runtime.HttpJsp {
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:19^9*/      {
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          ...
          /*@lineinfo:translated-code*//*@lineinfo:48^78*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
