  /*@lineinfo:filename=/bajas_arbitros.jsp*/
...
public class _bajas__arbitros extends com.orionserver.http.OrionHttpJspPage {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:27^13*/      {
        ...
        __jsp_taghandler_1.setAction("/bajasArbitros");
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                ...
                do {
                    ...
                    if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
                    {
                      ...
                      do {
                        ...
                        /*@lineinfo:translated-code*//*@lineinfo:42^25*/                        {
                          ...
                          __jsp_taghandler_4.setProperty("idarbitro");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:49^23*/                  {
                    ...
                    __jsp_taghandler_6.setProperty("telefono");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:55^23*/                  {
                    ...
                    __jsp_taghandler_8.setProperty("idnacionalidad");
                ...
                /*@lineinfo:translated-code*//*@lineinfo:55^76*/                } while (__jsp_taghandler_2.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
                __ojsp_s_out = (com.evermind.server.http.JspCommonExtraWriter) out;
              }
