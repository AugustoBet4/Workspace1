...
public class _altas__locaciones extends oracle.jsp.runtime.HttpJsp {
          ...
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:43^19*/            {
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                ...
                /*@lineinfo:translated-code*//*@lineinfo:44^95*/                } while (__jsp_taghandler_4.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
              }
