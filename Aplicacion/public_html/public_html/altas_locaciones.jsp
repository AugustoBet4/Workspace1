  ...
  <body>
    <div class="container">
      <div class="card mt-3">
        ...
        <div class="card-body">
          <html:form action="/altasLocaciones" styleClass="form-group" onsubmit="return fParams( )">
            ...
            <div class="row justify-content-md-center">
              <div class="col-md">
                <div class="form-group">
                  <h6>Nombre</h6>
                  <html:text property="locacion" styleClass="form-control" />
                </div>
              </div>
            </div>
            <div class="row justify-content-md-center">
              <div class="col-md">
                <div class="form-group">
                  <h6>Pais</h6>
                  <html:select property="pais" styleClass="form-control" >
